		...
		$.post(url, params, function(result) {
			...
			if (resultJSON.data.length > 0) {
				...
				for (var i = 0; i < resultJSON.data.length; i++) {
					var tr = "<tr>";
					tr += "<td>" + resultJSON.data[i].name + "</td>";
					tr += "<td>" + resultJSON.data[i].tag + "</td>";
					tr += "<td>" + resultJSON.data[i].url + "</td>";
					tr += "<td>" + to_date_hms(resultJSON.data[i].createTime) + "</td>";
					tr += "<td class=\"text-center\">";
					tr += "<a href=\"javascript:void(0);\" onclick=\"dataEdit('" + resultJSON.data[i].id + "')\" title=\"编辑\"><i class=\"glyphicon glyphicon-edit\"></i></a>&nbsp;&nbsp;";
					tr += "<a href=\"javascript:void(0);\" onclick=\"dataDelete('" + resultJSON.data[i].id + "')\" title=\"删除\"><i class=\"glyphicon glyphicon-trash\"></i></a>";
					tr += "<span class=\"parentId\" style=\"display:none\">" + resultJSON.data[i].id + ";" + resultJSON.data[i].parentId + "</span>";
					tr += "</td>";
					tr += "</tr>";
