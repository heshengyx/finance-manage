...
<html lang="zh-CN">
  <head>
    ...
    <link href="${ctx}/plugins/fontawesome/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <!-- Ionicons 2.0.0 -->
    <!-- <link href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" rel="stylesheet" type="text/css" /> -->
    <link href="${ctx}/plugins/fontawesome/ionicons.min.css" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
